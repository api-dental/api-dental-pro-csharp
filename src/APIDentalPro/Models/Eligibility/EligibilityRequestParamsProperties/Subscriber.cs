...
[JsonConverter(typeof(APIDentalPro::ModelConverter<Subscriber>))]
public sealed record class Subscriber : APIDentalPro::ModelBase, APIDentalPro::IFromRaw<Subscriber>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Subscriber(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Subscriber FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
